  ...
  const configSections = [
    {
      ...
      action: () => toast.info("Próximamente: Editar perfil")
    },
    {
      icon: Bell,
      title: "Notificaciones",
      description: "Configure las notificaciones del sistema",
      action: () => toast.info("Próximamente: Configurar notificaciones")
    },
    {
      icon: Shield,
      title: "Seguridad",
      description: "Gestione la seguridad de su cuenta",
      action: () => toast.info("Próximamente: Configurar seguridad")
    },
  ];
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3">
              {configSections.map((section, index) => (
                <Card key={index} className="hover:shadow-md transition-smooth cursor-pointer" onClick={section.action}>
